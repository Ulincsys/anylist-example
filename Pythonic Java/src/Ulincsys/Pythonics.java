...
public class Pythonics { //contains pythonic methods
	...
	public static int Int(Object initial, Object... other) {
		...
		String parse = null;
		if(initial != null) {
		parse = str(initial).trim();
		} else {
			error(2, "Int(Object)", eoff, "Null objects cannot be cast to type - int");
		}
		try {
	...
	public static String str(Object parse, Object... other) {
		...
		try {
			...
			error(2, "str(Object)", eoff, "Null objects cannot be cast to type - str");
		} catch(Exception e) {
	...
	public static boolean bool(Object[] other, boolean... EOFF) {
		...
		boolean parse = false;
		if(other.length == 0 || other[0] == null) {return false;}
	...
	public static String type(Object parse) {
	...
	//Type of error, occurrence root, continue after error, extra statements
